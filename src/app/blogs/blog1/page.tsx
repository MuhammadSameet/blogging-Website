...
import image6 from "@/app/assets/asset 7.jpeg"

export default function blog2(){
    return(
        <div className="blog-page">
            <Image src={image6} alt=" mountain img" className="blog-img" />
            <h1 className="blog-h">Hiking in Stanley, Idaho: the Best Trails & Lakes</h1>
